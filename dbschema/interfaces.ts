...
export namespace $default {
  export interface Creatable extends std.$Object {
    "created_at"?: Date | null;
    "author": ext.auth.Identity;
  }
  export interface Reaction extends Creatable {
    "post": Post;
  }
  export interface AngryFace extends Reaction {}
  export interface Comment extends Reaction {
    "text": string;
  }
  export interface Dislike extends Reaction {}
  export interface Post extends Creatable {
    "text": string;
  }
  export interface current_user extends ext.auth.Identity {}
}
export type Creatable = $default.Creatable;
export type Reaction = $default.Reaction;
export type AngryFace = $default.AngryFace;
export type Comment = $default.Comment;
export type Dislike = $default.Dislike;
...
export interface types {
  ...
  "default": {
    "Creatable": $default.Creatable;
    "Reaction": $default.Reaction;
    "AngryFace": $default.AngryFace;
    "Comment": $default.Comment;
    "Dislike": $default.Dislike;
    "Post": $default.Post;
